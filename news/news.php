	...
	<body>
				...
				<div class="news-col news-col-1">
					<section class="news-latest">
						<?php 
							...
							$query = "SELECT * FROM tblarticle WHERE type = 'news' LIMIT 6 ";
		...
		<div class="main-news">
			<div class="main-news-header main-news-header-gray">
				<h2 id="fresh-news">FRESH NEWS</h2>
			</div>
			<div class="news-main-hot">
				<div class="news-col news-col-1">
					<section class="news-latest">
						<?php 
							$conn = mysqli_connect("localhost", "1248099", "thedemocrat0", "1248099");
							$query = "SELECT * FROM tblarticle WHERE type = 'news' ORDER BY date_submitted DESC LIMIT 6 ";
							$result = mysqli_query($conn, $query);
			...
			</div> <!-- end of hn-content -->
		</div> <!-- end of hot-news-block -->
