				...
				<div class="news-col news-col-1">
					<section class="news-latest">
						<?php 
							...
							if($section == 'others'){
								$query = "SELECT * FROM tblarticle ORDER BY date_submitted DESC LIMIT $start, $per_page";
							}
							else{
								$query = "SELECT * FROM tblarticle WHERE type = '$section' ORDER BY date_submitted DESC LIMIT $start, $per_page";
							}
					...
					<?php 
						if($section == 'others'){
							...
							$query = "SELECT * FROM tblarticle WHERE type = '$section'";
						}
						...
						echo "<div class='row row-page row-btn-profile'>".
								"<a href='sections.php?page=1&sections=$section'><button class='special'>First Page</button></a>";
						...
						if($total_pages > 5){
							if($page > 2){
								...
								for($i = $lower; $i <= $upper; $i++){
									if($i == $page){
										echo "<a href='sections.php?page=".$i."&sections=$section'><button class='current'>".$i."</button></a>";	
									}
									else{
										echo "<a href='sections.php?page=".$i."&sections=$section'><button>".$i."</button></a>";	
									}
								}			
							}
							else{
						...
						echo "<a href='sections.php?page=".$total_pages."&sections=$section'><button class='special'>Last Page</button></a></div>";
