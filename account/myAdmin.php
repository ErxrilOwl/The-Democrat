...
<html lang="en-ph">
	...
	<body>
		<div class="container home">
			...
			<div class="main-content-1 myAdmin"">
				<?php 
					if(!isset($_SESSION['username'])){
						...
						echo "<div class='news-col news-col-1'>".
							"<div class='news-col-header myAdmin-header'>".
							"<h3 class='nh-latest'>My</h3><h3 class='nh-news'><span>Admin</span></h3></div>"."<section class='news-latest'>".
							"<div class=block><a href='newsubmission.php'><button class='admin-btn'>New Submission</button></a></div>
							<div class=block><a href='editprofile.php?id=".$_SESSION['username']."'><button class='admin-btn'>Edit Profile</button></a></div><div class=block>
							<a href='myAdminSubmissions.php'><button class='admin-btn'>My Submissions</button></a></div><div class=block>
							<a href='usersSubmission.php?=1'><button class='admin-btn'>User Submissions</button></a></div>
							<div class=block><a href='newCollection.php'><button class='admin-btn'>Add New Collection</button></a></div></section></div>
							<div id='twitter_widget' class='news-col news-col-2'><div class='dummy-block'></div><a class='twitter-timeline' data-width='370' data-height='400' href='https://twitter.com/uncthedemocrat?lang=en'>Tweets by @UNCTheDemocrat</a> <script async src='//platform.twitter.com/widgets.js' charset='utf-8'></script></div>";
					}
				?>
			</div>	
			<div class="red-bar"></div>
