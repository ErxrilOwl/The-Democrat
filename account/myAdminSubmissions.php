	...
	<body>
			...
			<div class="main-content-1 profile" id="profile">
								...
								if(isset($_SESSION["username"])){
									...
									if(mysqli_num_rows($result) > 0){
										while($row = mysqli_fetch_assoc($result)){
											...
											$script1 = "<article class='col-6 col-12'> <div class='ms-content'>".
														"<p class='status'>".$varStatus."...</p><div class='ms-img'>"; 
				...
				<?php 
					...
					echo "<div class='row row-page row-btn-profile'>".
							"<a href='myAdminSubmissions.php?page=1'><button class='special'>First Page</button></a>";
					...
					if($total_pages > 5){
						if($page > 2){
							...
							for($i = $lower; $i <= $upper; $i++){
								if($i == $page){
									echo "<a href='myAdminSubmissions.php?page=".$i."'><button class='current'>".$i."</button></a>";	
								}
								else{
									echo "<a href='myAdminSubmissions.php?page=".$i."'><button>".$i."</button></a>";	
								}
							}			
						}
						else{
					...
					echo "<a href='myAdminSubmissions.php?page=".$total_pages."'><button class='special'>Last Page</button></a></div>";
		...
		<script type="text/javascript">
			(function(){ 
				...
				document.getElementById("profile").style.height = ((count/2)*65)+"vh";
			})();
		</script>
	</body>
</html>
