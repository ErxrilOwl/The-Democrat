		...
		<div class="container home">
			...
			<header class="title-bar">
				...
				<div class="row nav-menu title-col-2">
					...
					<ul class="menu">
						<li class="menu-btn"><a class="nav-link-effect nav-before nav-after" href="../index.html">HOME</a></li>
				...
				<section class="news-latest">
					...
					<article class="col-6 col-12">
						<div class="nh-content">
							...
							<div class="nh-desc">
								<h4><a href="#">Lorem Ipsum Ipsum Ipsum Ipsum</a></h4>
								<p>
									By: Lorem Lorem <br/>
									August 30, 2016
								</p>
					...
					<article class="col-6 col-12">
						<div class="nh-content">
							...
							<div class="nh-desc">
								<h4><a href="#">Lorem Ipsum Lorem Ipsum Ipsum Ipsum</a></h4>
								<p>
									By: Lorem Lorem <br/>
									August 30, 2016
								</p>
